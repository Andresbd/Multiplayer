...
namespace Firebase.Sample.Database
{
    ...
    public class DBHandler : MonoBehaviour
    {
        ...
        {
            TMP = GameObject.Find("ScoreDisplay").GetComponent<TextMeshProUGUI>();
        ...
        protected virtual void InitializeFirebase()
        {
            ...
            app.SetEditorDatabaseUrl("REPLACEWITHDBURL");
              ...
              .ValueChanged += (object sender2, ValueChangedEventArgs e2) => {
                  ...
                  if (e2.Snapshot != null && e2.Snapshot.ChildrenCount > 0)
                  {
                    ...
                    || childSnapshot.Child("score").Value == null)
                          ...
                          {
                              HS = "High Score: " + childSnapshot.Child("score").Value.ToString();
                          }
                      }
                  }
              };
